...
class Finanzas:    
    def balance_general():
        ...
        if st.session_state['servicio_ip']:
            ...
            activo_p3_df[selected_moneda] = activo_p3_df[selected_moneda].astype(float)
            ...
            pasivo_p3_df[selected_moneda] = pasivo_p3_df[selected_moneda].astype(float)
            ...
            try:
                ...
                st.error("El Fondo de Maniobra no se ha podido calcular debido a incompatibilidad con el nombre de las partidas")
    ...
    def balance_ap():
        ...
        if st.session_state['servicio_ip']:
            ...
            try:
                ...
                st.error("Intente seleccionando otro Formato")
    def analisis_activo():
        styles(pt=1)
        if st.session_state['servicio_ip']:
            if st.session_state['servicio_parquet'] == True:
            ...
            fig_pie = pie_(
                    ...
                    height=330,
                    showlegend = True,
                    dict_color={'ACTIVO':"#2B4CEA",'ACTIVO CORRIENTE':'#2B4CEA','ACTIVO NO CORRIENTE':'#974EE6','ACTIVOS NO CORRIENTES':'#974EE6'},
                    hole = .6,
    ...
    def analisis_pasivo():
        ...
        if st.session_state['servicio_ip']:
            ...
            fig_pie = pie_(
                    ...
                    height=330,
                    showlegend = True,
                    dict_color={'PASIVO CORRIENTE':'#2B4CEA','PASIVO NO CORRIENTE':'#974EE6','PASIVOS CORRIENTES':'#2B4CEA','PASIVOS NO CORRIENTES':'#974EE6','PASIVO':"#974EE6"},
                    hole = .6,
